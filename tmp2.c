...
enum {PB_INIT, PB_DISTTOBOX ,PB_GOTOBOX, PB_GOTOBOX2, PB_GOTOBOX3, PB_GOTOBOXTIF, PB_GOTOBOX4, PB_GOTOBOX5, PB_GOTOBOX6, PB_GOTOBOX7, PB_GOTOBOX8, PB_GOTOBOX9, PB_PUSHBOX, PB_GOTONEXTCHAL,
  PB_GOTONEXTCHAL1, PB_GOTONEXTCHAL2, PB_GOTONEXTCHAL3, PB_GOTONEXTCHAL4, PB_GOTONEXTCHAL5, PB_GOTONEXTCHAL6, PB_GOTONEXTCHAL7, PB_GOTONEXTCHAL8, PB_FINISH, PB_GOTOBOX22, PB_GOTOBACK};
...
*/
   ...
   switch (mission.state) {
	...
	if (followLine(br,speed,mission.time, dist, condition)) {
	  boxDistance = (-1*odo.yOld) + 0.255 + laserpar[4];
	  printf("%s%f%s","distance to box: ",boxDistance,"\n");
